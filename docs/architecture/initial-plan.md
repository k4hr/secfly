# AeroGuard: исходный архитектурный план
...
Создать workspace, TypeScript boundaries, lint/typecheck/test harness, policy-файлы, CI и Compose-каркас. Готовность: пустые приложения собираются, архитектурные dependency rules проходят, реализация поведения отсутствует.
